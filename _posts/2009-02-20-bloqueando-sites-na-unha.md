...
author: rmmartins
layout: post
guid: 'http://ricardomartins.com.br/?p=488'
permalink: /bloqueando-sites-na-unha/
views:
    - '14959'
    - '14959'
    - '14959'
...
`@echo off<br></br>Attrib -r -s -h %WINDIR%system32driversetchosts<br></br>echo 127.0.0.1 www.orkut.com >> %SystemRoot%system32driversetchosts<br></br>echo 127.0.0.1 www.youtube.com >> %SystemRoot%system32driversetchosts<br></br>Attrib +r +h %WINDIR%system32driversetchosts`
